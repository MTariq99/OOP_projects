...
int createDataBase(student students[], int);
int appendNewRecord(student students[]);
void displayStudentsRecord(student stu[]);
int searchAStudent(student stu[], int);
int updateStudentRecord(student stu[], int);
int deleteAStudent(student stu[], int);
...
int createDataBase(student stu[], int NumberOfStudent, int &totalRegisteredStudents)
{
    ...
    else
    {
        ...
        {
            for (i = totalRegisteredStudents; i < SIZE; i++)
            {
